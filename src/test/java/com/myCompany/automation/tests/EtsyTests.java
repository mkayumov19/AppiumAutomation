...
public class EtsyTests {
    ...
    public void test() throws InterruptedException {
        ...
        driver.findElementById("com.etsy.android:id/edit_username").sendKeys("boqudalo@livinginsurance.co.uk");
        driver.findElementById("com.etsy.android:id/edit_password").sendKeys("Amerika1984");
...
//        }
        ...
        searchResults.forEach( e -> Assert.assertTrue(e.getText().toLowerCase(Locale.ROOT).contains("spoon")));
